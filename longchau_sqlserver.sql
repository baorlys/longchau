...
('MDC00010',N'Midorhum OPV', N'Hộp 10 vỉ x 10 viên', 4, '2022-12-31', N'CÔNG TY CỔ PHẦN DƯỢC PHẨM OPV',N'Thuốc Midorhum được chỉ định dùng trong các trường hợp sau:Ðiều trị các triệu chứng trong cảm lạnh và cảm cúm như đau nhức nhẹ, nhức đầu, sốt, ho, sổ mũi, hắt hơi, mẩn ngứa, chảy nước mắt.', 100000,0),
('MDC00011',N'Neo-Corclion F TV.pharm', N'Hộp 2 vỉ x 10 viên', 4, '2022-12-31', N'CÔNG TY CỔ PHẦN DƯỢC PHẨM TV.PHARM',N'Thuốc Neo - Corclion F được chỉ định dùng trong các trường hợp sau:Điều trị giảm ho trong các trường hợp ho gió, ho khan.', 100000,0),
('MDC00012',N'Cufo Lemon', N'Hộp 2 vỉ x 12 viên', 4, '2022-12-31', N'UNIQUE',N'Viên Ngậm Cufo Lemon có tác dụng hỗ trợ điều trị triệu chứng trong nhiễm khuẩn miệng và họng.', 100000,0),
('MDC00013',N'Opelomin', N'Hộp 2 vỉ x 2 viên', 5, '2022-12-31', N'OPV',N'Thuốc Opelomin 6 được chỉ định dùng trong các trường hợp sau:Ðiều trị giun chỉ (Onchocerca volvulus).Ðiều trị giun lươn (Strongyloides stercoralis).', 100000,0),
('MDC00014',N'Klavunamox', N'Hộp 3 vỉ x 15 viên', 5, '2022-12-31', N'ATABAY',N'Thuốc Klavunamox 625 mg được chỉ định dùng điều trị nhiễm khuẩn gây nên bởi các chủng nhạy cảm trong các trường hợp cụ thể sau đây:Nhiễm khuẩn bộ máy hô hấp:Nhiễm khuẩn đường hô hấp trên: Viêm xoang, viêm amidan, viêm tai giữa, những nhiễm khuẩn khác ở vùng tai-mũi-họng.Nhiễm khuẩn đường hô hấp dưới: Viêm phế quản cấp và mạn tính, viêm phổi, viêm mủ màng phổi, abces phổi.Nhiễm khuẩn da và mô mềm: Đinh, nhọt, abces, viêm mô tế bào, nhiễm khuẩn vết thương, nhiễm khuẩn trong bụng.Nhiễm khuẩn đường tiết niệu - sinh dục: Viêm bàng quang, viêm thận - bể thận, viêm niệu đạo, nhiễm khuẩn vùng khung chậu, giang mai, lậu.Các nhiễm khuẩn khác: Viêm xương tủy.', 100000,0),
('MDC00015',N'Auclanityl Tipharco', N'Hộp 2 vỉ x 7 viên', 5, '2022-12-31', N'TIPHARCO',N'Điều trị các nhiễm khuẩn do các vi khuẩn nhạy cảm trong các trường hợp:Nhiễm khuẩn nặng đường hô hấp trên: Viêm amidan, viêm xoang, viêm tai giữa đã được điều trị bằng các kháng sinh thông thường nhưng không giảm.Nhiễm khuẩn đường hô hấp dưới bởi các chủng H.influenzae và Branhamella catarrbalis sản sinh beta – lactamase: Viêm phế quản cấp và đợt cấp của viêm phế quản mạn, viêm phổi mắc phải ở cộng đồng.Nhiễm khuẩn nặng đường tiết niệu bởi các chủng E. coli, Klebsiella và Enterobacter sản sinh: Viêm bàng quang, viêm niệu đạo, viêm bể thận.Nhiễm khuẩn da và mô mềm: Mụn nhọt, áp xe, nhiễm khuẩn vết thương.Nhiễm khuẩn xương và khớp: Viêm tủy xương.', 100000,0),
('MDC00016',N'Histalong - L 5mg Dr.Reddy",s', N'Hộp 2 vỉ x 10 viên', 6, '2022-12-31', N'DR.REDDY',N'Thuốc Histalong L được chỉ định dùng trong trường hợp sau:Ðiều trị triệu chứng viêm mũi dị ứng (kể cả viêm mũi dị ứng dai dẳng) và mày đay ở người lớn và trẻ em từ 6 tuổi trở lên.', 100000,0),
('MDC00017',N'Fefasdin 60 Khapharco', N'Hộp 10 vỉ x 10 viên', 6, '2022-12-31', N'KHAPHARCO PHARM. CO.',N'Thuốc FEFASDIN 60 được chỉ định dùng trong các trường hợp sau:Điều trị triệu chứng trong viêm mũi dị ứng theo mùa, mày đay mạn tính vô căn ở người lớn và trẻ em trên 6 tuổi.', 100000,0),
('MDC00018',N'Telfast HD 180mg Sanofi', N'Hộp 1 vỉ x 10 viên', 6, '2022-12-31', N'SANOFI',N'Thuốc Telfast 180mg được chỉ định dùng trong các trường hợp sau:Ðiều trị viêm mũi dị ứng: Telfast HD 180 mg được chỉ định để điều trị viêm mũi dị ứng theo mùa ở người lớn và trẻ em từ 12 tuổi trở lên.Ðiều trị mày đay vô căn mạn tính: Telfast HD 180 mg được chỉ định để điều trị các biểu hiện ngoài da không biến chứng của mày đay vô căn mạn tính ở người lớn và trẻ em từ 12 tuổi trở lên. Thuốc làm giảm ngứa và số lượng dát mày đay một cách đáng kể.', 100000,0);
GO